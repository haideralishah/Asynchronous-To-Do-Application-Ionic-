 ...
 *       })
 *       .state('tabs.addTask.html', {
 *         url: "/addTask.html",
 *         views: {
 *           'addTask.html-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/addTask.html.html",
  ...
  function($scope, $attrs, $element, $ionicBind, $timeout) {
    ...
    $scope.$on('scroll.refreshComplete', function() {
      ...
      $timeout(function() {
        ...
        // scroll back to addTask.html during tail animation
        scrollTo(0, scrollTime, deactivate);
 ...
 *
 * ```html
 * <a menu-close href="#/addTask.html" class="item">Home</a>
 * ```
 *
 ...
 *
 * ```html
 * <a nav-direction="forward" href="#/addTask.html">Home</a>
 * ```
 */
IonicModule
 ...
 *
 * ```html
 * <a nav-transition="none" href="#/addTask.html">Home</a>
 * ```
 */
IonicModule
 ...
 * and then try to load addTask.html.html into the `<ion-nav-view>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put addTask.html.html into our app:
 *
 * ```html
 * <script id="addTask.html" type="text/ng-template">
